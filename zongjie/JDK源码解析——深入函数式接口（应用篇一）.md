...
既然没有省略控制逻辑，难道我们费这么大的力气引入这个东东就只是为了简洁点？指北君画了一下调用逻辑，参见下图![图片](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg==)
